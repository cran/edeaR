...
globalVariables(c(".N","event_classifier", "activity_instance_classifier", "absolute_frequency", "Freq","q1", "q3","st_dev",
				  ...
				  "cnt", "trace_frequency", "V1","V2",".","event_id","freq", "element_type"))

...
all_repetitions <- function(eventlog) {
	.N <- NULL
...
all_repetitions_case <- function(eventlog) {
...
all_repetitions_size_case <- function(eventlog) {
	eventlog %>%
		all_repetitions()  %>%
		group_by(!!case_id_(eventlog)) %>%
...
all_repetitions_log <- function(eventlog) {
	absolute <- NULL
	eventlog %>%
		all_repetitions_case -> raw
...
all_repetitions_size_log <- function(eventlog) {
	eventlog %>%
		all_repetitions -> raw
...
all_repetitions_activity <- function(eventlog) {
...
all_repetitions_size_activity <- function(eventlog) {
...
all_repetitions_resource <- function(eventlog) {
...
all_repetitions_size_resource <- function(eventlog) {
...
all_repetitions_resource_activity <- function(eventlog) {
...
all_repetitions_size_resource_activity <- function(eventlog) {
